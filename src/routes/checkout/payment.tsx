                  ...
                  {[
                    ...
                    return (
                      <button
                        ...
                        className={`group flex flex-col items-center justify-center gap-2 p-4 rounded-xl md:rounded-2xl border transition-all duration-500 cursor-pointer ${active
